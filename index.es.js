...
var vr = Z.exports;
const pr = ({ children: w }) => /* @__PURE__ */ vr.jsx("button", { className: "button", role: "button", children: w });
export {
  pr as Button
};
